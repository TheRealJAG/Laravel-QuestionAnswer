...
<!-- Question Container-->
    <div class="row">
        ...
        <div class="col-xs-10 col-md-11">
            <h3 style="color: #2a88bd;font-weight: bolder;margin-top: 0"><a href="/question/{{$question->id}}/{{ App\Classes\Url::get_slug($question->question) }}" title="{{ $question->question }}">{{ $question->question }}</a></h3>
