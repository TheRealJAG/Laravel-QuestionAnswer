                    ...
                    <div class="panel-body">
                        @if (Auth::id())
                            <ul class="sidebar-nav sidebar-divider">
                                <li>
                                    <a href="/user/{{Auth::id()}}/questions" title="My Questions"><i class="fa fa-lightbulb-o" style="color: #4285F4;"></i> <strong>My Questions</strong></a>
                                </li>
                                <li>
                                    <a href="/user/{{Auth::id()}}/answers" title="My Answers"><i class="fa fa-bullhorn" style="color: #4285F4;"></i> <strong>My Answers</strong></a>
                                </li>
                                <li>
                                    <a href="/user/{{Auth::id()}}/participation" title="My Participation"><i class="fa fa-share-alt" style="color: #4285F4;"></i> <strong>My Participation</strong></a>
                                </li>
                            </ul>
                        @endif
                ...
                <div class="panel panel-default">
                    ...
                    <!-- END Show the answer form -->
                        ...
                        @endif
                            ...
                            <div id="questions">
                                <legend class="text-left">Relevant</legend>
                            </div>
